...
metadata_file <- file.path(project_dir, 'data_raw', 'metadata.csv')
...
# Import Data -------------------------------------------------------------
cd_results_file <- file.path(project_dir, 'data_raw', 'CompoundsChecked-IsolatesGerm.csv')
