...
CTRL.plant.samples<-c('41plus_RP_pos_MS2', '40plus_RP_pos_MS2','2plus_RP_pos_MS2')
...
table_file <- file.path(tables_dir, 'F1154_Diff_expressed_ERLE.csv')
...
table_file <- file.path(tables_dir, 'F1154_Diff_expressed_ERIN.csv')
...
table_file <- file.path(tables_dir, 'F1154_Diff_expressed_BOCU.csv')
...
table_file <- file.path(tables_dir, 'F1154_Diff_expressed_LEDU.csv')
