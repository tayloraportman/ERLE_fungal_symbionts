...
table_file <- file.path(tables_dir, 'F1246_Diff_expressed_ERLE.csv')
...
table_file <- file.path(tables_dir, 'F1246_Diff_expressed_ERIN.csv')
...
table_file <- file.path(tables_dir, 'F1246_Diff_expressed_BOCU.csv')
...
table_file <- file.path(tables_dir, 'F1246_Diff_expressed_LEDU.csv')
