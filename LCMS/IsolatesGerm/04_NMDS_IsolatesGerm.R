...
nmds_plot <- plot_nmds(nmds.scores, Plant, Fungi, color) +
...
set.seed(456)
permanova <- adonis2(dm ~ Fungi+ Plant, 
                     data= metadata, 
                     permutations=999, 
                     method="bray")
permanova #Marginally Significant Plant p=0.096

permanova <- adonis2(dm ~ Fungi, 
                    data= metadata, 
                    permutations=999, 
                    method="bray")
permanova #Not sig: p=0.341
