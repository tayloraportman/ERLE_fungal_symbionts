...
compounds_table <- read_csv("~/Google Drive/My Drive/projects/ERLE_fungal_symbionts/IsolatesAll/RP_All_checked_output_tables/compounds_table.csv")

color<- c( "#E64B35B2", "#4DBBD5B2",  "#00A087B2",  '#7E6148B2')

figures_dir <- file.path("~/Google Drive/My Drive/projects/ERLE_fungal_symbionts/IsolatesAll/RP_All_checked_output_figures")
```
...
caffeic.plot<- ggplot(caffeic.acid, aes(x=Plant, y=AUC, fill=Plant, color=Plant))+
  geom_boxplot(alpha=0.7)+
  theme_classic()+
  scale_color_manual(values=color)+
  scale_fill_manual(values=color)+
