...
setwd("/Volumes/GoogleDrive/My Drive/projects/ERLE_fungal_symbionts/IsolatesAll_1154")
# set path variables
...
compounds_table <- read_csv(compounds_table_nogap_file)
comounds_table_nogap<-read_csv(compounds_table_nogap_file)
#compounds_table<-compounds_table_nogap_file
...
nmds_plot <- plot_nmds(nmds.scores, Plant) +
...
pca_plot <- plot_dotplot(pca_coordinates, PC1, PC2, Plant) +
  labs(title = 'PCA plot',
       x = pc1,
       y = pc2)
pca_plot
